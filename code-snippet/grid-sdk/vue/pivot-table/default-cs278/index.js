...
import Vue from "vue";
import { PivotViewPlugin, ExcelExport, FieldList } from "@syncfusion/ej2-vue-pivotview";
...
new Vue({
  ...
  template: `
    <div id="app">
        ...
        <ejs-pivotview id="pivotview" :height="height" :dataSourceSettings="dataSourceSettings" :allowExcelExport="allowExcelExport" :dataBound="ondataBound"
