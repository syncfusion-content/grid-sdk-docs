...
import Vue from "vue";
import { PivotViewPlugin, PDFExport, FieldList } from "@syncfusion/ej2-vue-pivotview";
...
new Vue({
  ...
  template: `
    <div id="app">
        ...
        <ejs-pivotview id="pivotview" :height="height" :dataSourceSettings="dataSourceSettings" :allowPdfExport="allowPdfExport" :dataBound="ondataBound"
