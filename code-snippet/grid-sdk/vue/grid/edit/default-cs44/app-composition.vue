...
import { GridComponent as EjsGrid, ColumnDirective as EColumn, ColumnsDirective as EColumns, Page, DetailRow } from "@syncfusion/ej2-vue-grids";
...
const rowDataBound = (args) => {
  ...
  let childrecord = new DataManager(Grid.value.childGrid.dataSource).executeLocal(new Query().where("EmployeeID", "equal", parseInt(filter), true));
