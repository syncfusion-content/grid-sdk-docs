  ...
  <div id="app">
    <ejs-grid ref="grid" :dataSource="data" :allowPaging="true" height="273px">
      <e-columns>
        ...
        <e-column field="OrderDate" headerText="Order Date" width="135" format="yMd" type="date"
          :headerTemplate="dateTemplate" textAlign="Right"></e-column>
...
provide('grid', [Page, Filter, Sort, Edit, Toolbar]);
</script>
<style>
