...
import { TreeGridComponent as EjsTreegrid, Page, Toolbar, Edit, ColumnDirective as EColumn, ColumnsDirective as EColumns } from "@syncfusion/ej2-vue-treegrid";
import { stackedData } from "./datasource.js";

const data = stackedData;

const editSettings = { allowAdding:true, allowDeleting:true, allowEditing: true, mode: 'Row' };
