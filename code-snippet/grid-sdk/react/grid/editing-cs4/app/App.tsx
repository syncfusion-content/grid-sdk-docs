...
import { Edit, EditSettingsModel, Inject, Toolbar, ToolbarItems, CellEditArgs, BeforeBatchAddArgs, BeforeBatchDeleteArgs } from '@syncfusion/ej2-react-grids';
...
function App() {
  ...
  const beforeBatchAdd = (args: BeforeBatchAddArgs) => {
    if (!isAddable) {
      args.cancel = true;
    }
  }
  const beforeBatchDelete = (args: BeforeBatchDeleteArgs) => {
    if (args.rowData['Role'] == 'Admin') {
      args.cancel = true;
    }
  }
