      ...
      <div>
        ...
        <div className="form-row">
          <div className="form-group col-md-12">
            ...
            <DropDownListComponent value={(selectedProduct as any).ShipCountry || '' } dataSource={dropdown} fields={dropdownFields} change={(e) => handleInputChange('ShipCountry', e.value)}></DropDownListComponent>
          </div>
        </div>
      </div>
