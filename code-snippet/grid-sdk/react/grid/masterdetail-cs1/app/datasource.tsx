...
export let orderData: any = JSON.parse(stringData, function (field, value) {
    var dupValue = value;
...
export let data = orderData.map(function (item:any) {
    var name = customerData.filter(function (cItem:any) {
