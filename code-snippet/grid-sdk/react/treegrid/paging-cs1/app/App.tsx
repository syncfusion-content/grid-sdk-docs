...
function App() {
  ...
  const pageOptions: PageSettingsModel = {pageSizes: ["5", "10", "All"]};
  
    return (
      <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping='subtasks' allowPaging={true} pageSettings={pageOptions} height={273}>
        <ColumnsDirective>
