...
function App() {
    ...
    return <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping='subtasks' allowPaging={true} pageSettings={{ pageSize: 7 }} allowExcelExport={true} height='220' toolbarClick={toolbarClick} ref={g => treegridInstance = g} toolbar={toolbarOptions}>
        <ColumnsDirective>
