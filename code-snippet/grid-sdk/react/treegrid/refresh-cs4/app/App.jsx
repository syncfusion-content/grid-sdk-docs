...
import { Filter, Toolbar, Page, PdfExport } from '@syncfusion/ej2-react-treegrid';
/* tslint:disable */
function App() {
    ...
    return (<TreeGridComponent dataSource={projectData} treeColumnIndex={1} idMapping='TaskID' parentIdMapping='parentID' pageSettings={pageOptions} toolbarClick={toolbarClick} toolbar={toolbarOptions} allowPaging={true} ref={g => treegrid = g} allowFiltering={true} allowPdfExport={true}>
        <ColumnsDirective>
