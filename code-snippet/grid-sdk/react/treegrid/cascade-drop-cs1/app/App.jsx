...
function App() {
        ...
        write: () => {
            priorityObj = new DropDownList({
                change: () => {
                    ...
                    const tempQuery = new Query().where('priorityId', 'equal', priorityObj.value);
    ...
    return (<TreeGridComponent dataSource={projectData} treeColumnIndex={1} idMapping='TaskID' parentIdMapping='parentID' editSettings={editOptions} toolbar={toolbarOptions} ref={g => treegridObj = g} height={273}>
        <ColumnsDirective>
