...
import { IDataSet, PivotViewComponent, PDFExport, Inject, ExportCompleteEventArgs } from '@syncfusion/ej2-react-pivotview';
  ...
  return (
    <div>
      <div className="col-md-9"> <PivotViewComponent ref={(d: PivotViewComponent) => pivotObj = d} id='PivotView' height={350} dataSourceSettings={dataSourceSettings}
        allowPdfExport={true} enableVirtualization={true} exportComplete={exportComplete.bind(this)}>
