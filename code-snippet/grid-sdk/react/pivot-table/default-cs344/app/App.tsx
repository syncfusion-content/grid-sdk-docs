...
import { IDataSet, PivotViewComponent, PDFExport, Inject, FieldList, AggregateEventArgs, AggregateTypes, SummaryTypes } from '@syncfusion/ej2-react-pivotview';
    ...
    <div>
      <div className="col-md-9">
        <PivotViewComponent ref={(d: PivotViewComponent) => pivotObj = d} id='PivotView' height={350} dataSourceSettings={dataSourceSettings}
          allowPdfExport={true} showFieldList={true} dataBound={dataBound.bind(this)} aggregateCellInfo={aggregateCell.bind(this)}>
          <Inject services={[PDFExport, FieldList]} />
        </PivotViewComponent>
      </div>
