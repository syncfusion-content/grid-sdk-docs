...
import { IDataSet, PivotViewComponent, PDFExport, Inject, BeforeExportEventArgs } from '@syncfusion/ej2-react-pivotview';
...
function App() {
  ...
  return (
    <div>
      <div className="col-md-9"> <PivotViewComponent ref={(d: PivotViewComponent) => pivotObj = d} id='PivotView' height={350} dataSourceSettings={dataSourceSettings} allowPdfExport={true} beforeExport={beforeExport.bind(this)}>
