...
function App() {
  ...
  return (<PivotViewComponent  ref={ (d: PivotViewComponent) => pivotObj = d } id='PivotView' height={350} dataSourceSettings={dataSourceSettings} gridSettings={gridSettings} cellSelecting={onCellSelecting}></PivotViewComponent>);
};
