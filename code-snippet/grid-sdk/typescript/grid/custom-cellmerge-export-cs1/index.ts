...
import { Grid, PdfQueryCellInfoEventArgs } from '@syncfusion/ej2-grids';
import {PdfExport, PdfGridCell,Toolbar ,Page} from '@syncfusion/ej2-grids';
import { data } from './datasource.ts';

Grid.Inject( PdfExport,Toolbar,Page);
// global variable declaration for pdf Export
let currentCell: PdfGridCell;
let currentOrderID :Number = null;
let cellIndexCount:Number =1;
