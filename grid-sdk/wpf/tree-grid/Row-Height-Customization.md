...
description: Learn about Row Height Customization in the Syncfusion® WPF TreeGrid control. Adjust row heights dynamically for better layout and readability.
platform: grid-sdk
control: SfTreeGrid
documentation: ug
---
