---
layout: post
title: Freeze Headers in WPF Pivot Table | Syncfusion®
description: Freeze headers in the Syncfusion® WPF Pivot Table control to keep row and column headers visible during scrolling for easier data navigation.
platform: grid-sdk
control: Pivot Table
documentation: ug
---
