---
layout: post
title: Restrict Resizing of Row Header in WPF Pivot Table | Syncfusion®
description: Restrict Resizing of Row Header in the Syncfusion® WPF Pivot Table control prevents row headers from stretching when multiple PivotCalculation items are added.
platform: grid-sdk
control: Pivot Table
documentation: ug
---
