---
layout: post
title: Cell Selection in WPF Pivot Table | Syncfusion®
description: Cell Selection in the Syncfusion® WPF Pivot Table control allows selecting rows, columns, or headers to highlight and analyze pivot data.
platform: grid-sdk
control: Pivot Table
documentation: ug
---
