---
layout: post
title: RTL Support in WPF Pivot Table | Syncfusion®
description: RTL Support in the Syncfusion® WPF Pivot Table control enables right-to-left text flow for languages like Arabic and Hebrew, improving localization.
platform: grid-sdk
control: Pivot Table
documentation: ug
---

# RTL Support in WPF Pivot Table
