---
layout: post
title: Custom Summary in WPF Pivot Table | Syncfusion®
description: Custom Summary in the Syncfusion® WPF Pivot Table control lets users define personalized calculations and display results in pivot reports.
platform: grid-sdk
control: Pivot Table
documentation: ug
---
