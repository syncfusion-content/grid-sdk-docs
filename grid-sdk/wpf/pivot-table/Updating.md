---
layout: post
title: Updating in WPF Pivot Table | Syncfusion®
description: Updating in the Syncfusion® WPF Pivot Table control enables real-time changes with automatic recalculation and refresh throttling using ThrottleUpdateRate.
platform: grid-sdk
control: Pivot Table
documentation: ug
---
