---
layout: post
title: Custom Calculations in WPF Pivot Table | Syncfusion®
description: Define custom calculations in the Syncfusion® WPF Pivot Table control to create user-defined formulas and extend pivot table analysis.
platform: grid-sdk
control: Pivot Table
documentation: ug
---
