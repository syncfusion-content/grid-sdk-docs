---
layout: post
title: Sorting by Values in WPF Pivot Table | Syncfusion®
description: Sorting by Values in the Syncfusion® WPF Pivot Table control lets users sort value columns, totals, or grand totals in ascending or descending order.
platform: grid-sdk
control: Pivot Table
documentation: ug
---

# Sorting by Values in WPF Pivot Table
