---
layout: post
title: Binding PivotSchemaDesigner in WPF Pivot Table | Syncfusion®
description: Bind the PivotSchemaDesigner to the Syncfusion® WPF Pivot Table control to configure fields, measures, and hierarchies interactively for pivot analysis.
platform: grid-sdk
control: Pivot Table
documentation: ug
---

# Binding PivotSchemaDesigner in WPF Pivot Table
