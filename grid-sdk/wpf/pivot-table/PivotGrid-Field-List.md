---
layout: post
title: PivotGrid Field List in WPF Pivot Table | Syncfusion®
description: Manage fields using the PivotGrid Field List in the Syncfusion® WPF Pivot Table control to customize layouts and configure pivot analysis.
platform: grid-sdk
control: Pivot Table
documentation: ug
---
