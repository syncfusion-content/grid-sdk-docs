---
layout: post
title: Editing in WPF Pivot Table | Syncfusion®
description: Enable editing in the Syncfusion® WPF Pivot Table control to modify cell values directly and update pivot table data at runtime.
platform: grid-sdk
control: Pivot Table
documentation: ug
---
