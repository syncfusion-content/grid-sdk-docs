---
layout: post
title: Grouping Bar in WPF Pivot Table | Syncfusion®
description: Grouping bar in the Syncfusion® WPF Pivot Table control provides quick actions to drag, drop, and arrange fields for customizing pivot table layout.
platform: grid-sdk
control: Pivot Table
documentation: ug
---

# Grouping Bar in WPF Pivot Table
