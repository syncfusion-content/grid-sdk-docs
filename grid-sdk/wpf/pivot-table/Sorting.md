---
layout: post
title: Sorting in WPF Pivot Table | Syncfusion®
description: Sorting in the Syncfusion® WPF Pivot Table control organizes data in ascending or descending order using built-in or custom comparers for better analysis.
platform: grid-sdk
control: Pivot Table
documentation: ug
---

# Sorting in WPF Pivot Table
