---
layout: post
title: Display Options in WPF Pivot Table | Syncfusion®
description: Configure display options in the Syncfusion® WPF Pivot Table control to customize layout, headers, and data presentation at runtime.
platform: grid-sdk
control: Pivot Table
documentation: ug
---

# Display Options in WPF Pivot Table
