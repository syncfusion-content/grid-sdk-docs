---
layout: post
title: Getting Started with WPF Pivot Table | Syncfusion®
description: Learn how to get started with the Syncfusion® WPF Pivot Table control. Explore setup, features, examples, and customization options.
platform: grid-sdk
control: Pivot Table
documentation: ug
---
