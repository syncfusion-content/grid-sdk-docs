---
layout: post
title: Data Binding in WPF Pivot Table | Syncfusion®
description: Bind data sources to the Syncfusion® WPF Pivot Table control to display and analyze relational data in a pivot table format.
platform: grid-sdk
control: Pivot Table
documentation: ug
---
