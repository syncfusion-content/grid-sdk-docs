---
layout: post
title: Search in WPF Data Grid | Syncfusion®
description: Search in Data Grid quickly locates records across grid data to improve navigation, data access, and productivity.
platform: grid-sdk
control: Data Grid
documentation: ug
---
