...
<dataGrid:SfDataGrid x:Name="sfDataGrid"
    ...
    <dataGrid:SfDataGrid.Columns>
        ...
        <dataGrid:GridTextColumn MappingName="CustomerName" HeaderText="Customer Name" InitialSortDirection="Ascending" />
...
{% endhighlight %}
{% highlight c# %}
this.sfDataGrid.Columns["OrderID"].InitialSortDirection = ListSortDirection.Descending;
this.sfDataGrid.Columns["CustomerName"].InitialSortDirection = ListSortDirection.Ascending;
{% endhighlight %}
{% endtabs %}
...
When [SfDataGrid.AllowTriStateSorting](https://help.syncfusion.com/cr/winui/Syncfusion.UI.Xaml.Grids.SfGridBase.html#Syncfusion_UI_Xaml_Grids_SfGridBase_AllowTriStateSorting) is enabled, the sorting sequence includes clear sorting after the ascending and descending states.
...
![Descending sorting example](Sorting-images/winui-datagrid-initial-sorting-descending.gif)
...
![Ascending sorting example](Sorting-images/winui-datagrid-initial-sorting-ascending.gif)
...
You can prevent sorting for the particular column through [GridSortColumnsChangingEventArgs.Cancel](https://learn.microsoft.com/en-us/dotnet/api/system.componentmodel.canceleventargs.cancel?view=net-6.0) property of `SortColumnsChanging` event.
