...
description: Learn about ToolTip support in Syncfusion® WinUI DataGrid control, enabling customized tooltips to display additional information for cells and rows.
platform: grid-sdk
control: DataGrid
documentation: ug
---
