...
To customize the AddNewRowText, add the default [Syncfusion.Grid.WinUI.resw](https://help.syncfusion.com/winui/datagrid/crud-operations#customizing-addnewrow-text-using-default-resource-file) file in **Resources** folder and then customize the value of AddNewRowText. Refer [here](https://help.syncfusion.com/winui/localization) to learn more about localization. 
