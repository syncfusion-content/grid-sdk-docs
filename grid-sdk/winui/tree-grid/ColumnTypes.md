...
description: Column Types in TreeGrid support text, numbers, dates, times, checkboxes, templates, combos, and links with simple options for styling and formatting.
platform: grid-sdk
control: TreeGrid
documentation: ug
---
