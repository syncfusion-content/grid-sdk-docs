---
layout: post
title: ASP.NET MVC TreeGrid Row Drag and Drop | Syncfusion
description: Learn how to use Row Drag and Drop in ASP.NET MVC TreeGrid to reorder rows, configure drag-and-drop behavior, and update hierarchical data.
platform: grid-sdk
...
# Row Drag and Drop in ASP.NET MVC TreeGrid
...
{% include code-snippet/grid-sdk/asp-net-mvc/tree-grid/row/row-drag-single/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Dragdrop.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/tree-grid/row/row-drag-single/dragdrop.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/grid-sdk/asp-net-mvc/tree-grid/row/row-drag-single/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Dragdrop.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/tree-grid/row/row-drag-single/dragdrop.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/tree-grid/row/row-drag-drop/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Dragdrop.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/tree-grid/row/row-drag-drop/dragdrop.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/tree-grid/row/row-drag-drop/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Dragdrop.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/tree-grid/row/row-drag-drop/dragdrop.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/tree-grid/row/prevent-reorder/razor %}
{% endhighlight %}
{% highlight c# tabtitle="reorder.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/tree-grid/row/prevent-reorder/reorder.cs %}
{% endhighlight %}
{% endtabs %}
