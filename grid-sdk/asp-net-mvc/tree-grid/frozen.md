---
layout: post
title: ASP.NET MVC TreeGrid Frozen Columns | Syncfusion
description: Learn how to pin or freeze columns in ASP.NET MVC TreeGrid to keep important columns visible while scrolling horizontally.
platform: grid-sdk
control: Frozen
...
# Frozen Columns in ASP.NET MVC TreeGrid
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/tree-grid/scrolling/isfreezecol/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Isfreeze.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/tree-grid/scrolling/isfreezecol/isfreeze.cs %}
{% endhighlight %}
