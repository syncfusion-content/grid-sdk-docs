---
layout: post
title: ASP.NET MVC TreeGrid Row Selection | Syncfusion
description: Learn how to use row selection in ASP.NET MVC TreeGrid, including programmatic selection, selected records, row indexes, and persistent selection.
platform: grid-sdk
...
# Row Selection in ASP.NET MVC TreeGrid
...
{% include code-snippet/grid-sdk/asp-net-mvc/tree-grid/selection/toggleselection/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Toggleselection.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/tree-grid/selection/toggleselection/toggleselection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/grid-sdk/asp-net-mvc/tree-grid/selection/toggleselection/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Toggleselection.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/tree-grid/selection/toggleselection/toggleselection.cs %}
{% endhighlight %}
