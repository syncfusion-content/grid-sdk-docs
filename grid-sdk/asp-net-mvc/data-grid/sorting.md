---
layout: post
title: ASP.NET MVC Grid Sorting | Syncfusion
description: Learn how to use Sorting in ASP.NET MVC Data Grid to sort data by one or more columns, customize sorting behavior, and control sort indicators.
platform: grid-sdk
control: Sorting
...
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/sorting/razor %}
{% endhighlight %}
{% highlight c# tabtitle="sorting.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/sorting/sorting.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/initial-sort/razor %}
{% endhighlight %}
{% highlight c# tabtitle="initial-sort.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/initial-sort/initial-sort.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/multi-column-sort/razor %}
{% endhighlight %}
{% highlight c# tabtitle="multi-column-sort.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/multi-column-sort/multi-column-sort.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/sorting-prevent/razor %}
{% endhighlight %}
{% highlight c# tabtitle="sorting.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/sorting-prevent/sorting.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/sorting-compare/razor %}
{% endhighlight %}
{% highlight c# tabtitle="sorting.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/sorting-compare/sorting.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/sort-comparer/razor %}
{% endhighlight %}
{% highlight c# tabtitle="sort-comparer.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/sort-comparer/sort-comparer.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/foreign-sort-local/razor %}
{% endhighlight %}
{% highlight c# tabtitle="foreign-sort" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/foreign-sort-local/foreign-sort.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/foreign-sort-remote/razor %}
{% endhighlight %}
{% highlight c# tabtitle="foreign-sort" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/foreign-sort-remote/foreign-sort.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/sorting-sort-currency/razor %}
{% endhighlight %}
{% highlight c# tabtitle="sorting.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/sorting-sort-currency/sorting.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/sort-customize/razor %}
{% endhighlight %}
{% highlight c# tabtitle="sort-custom.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/sort-customize/sort-custom.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/sorting-sort-column/razor %}
{% endhighlight %}
{% highlight c# tabtitle="sorting.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/sorting-sort-column/sorting.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/sorting-sort-remove/razor %}
{% endhighlight %}
{% highlight c# tabtitle="sorting.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/sorting-sort-remove/sorting.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/sorting-sort-clear/razor %}
{% endhighlight %}
{% highlight c# tabtitle="sorting.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/sorting-sort-clear/sorting.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/sort-event/razor %}
{% endhighlight %}
{% highlight c# tabtitle="sort-event.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/sorting/sort-event/sort-event.cs %}
{% endhighlight %}
{% endtabs %}
