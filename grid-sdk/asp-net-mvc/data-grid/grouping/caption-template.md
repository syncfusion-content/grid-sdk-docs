---
layout: post
title: ASP.NET MVC Grid Caption Template | Syncfusion
description: Learn how to customize group captions in ASP.NET MVC Data Grid using Caption Template, apply custom content, formatting, and display group information effectively.
platform: grid-sdk
...
{% include code-snippet/grid-sdk/asp-net-mvc/grid/grouping/group-caption-template/razor %}
{% endhighlight %}
{% highlight c# tabtitle="group.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/grouping/group-caption-template/group.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/grouping/group-customtext-caption-template/razor %}
{% endhighlight %}
{% highlight c# tabtitle="group.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/grouping/group-customtext-caption-template/group.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/grouping/group-caption-locale/razor %}
{% endhighlight %}
{% highlight c# tabtitle="group.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/grouping/group-caption-locale/group.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/grouping/group-caption-component/razor %}
{% endhighlight %}
{% highlight c# tabtitle="group.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/grouping/group-caption-component/group.cs %}
{% endhighlight %}
{% endtabs %}
