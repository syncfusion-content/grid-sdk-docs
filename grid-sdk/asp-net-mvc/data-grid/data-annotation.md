---
layout: post
title: ASP.NET MVC Grid Data Annotation | Syncfusion
description: Learn how to use data annotations in ASP.NET MVC Data Grid to enable model validation, display attributes, and custom validation messages.
platform: grid-sdk
...
# Data Annotation in ASP.NET MVC Data Grid
...
{% include code-snippet/grid-sdk/asp-net-mvc/grid/data-annotation/annotation/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/data-annotation/annotation/annotation.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/grid-sdk/asp-net-mvc/grid/data-annotation/annotation/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/data-annotation/annotation/annotation.cs %}
{% endhighlight %}
