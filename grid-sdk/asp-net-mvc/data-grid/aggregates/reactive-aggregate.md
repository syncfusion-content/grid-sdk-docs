---
layout: post
title: ASP.NET MVC Grid Reactive Aggregate | Syncfusion
description: Learn how to use reactive aggregates in ASP.NET MVC Data Grid to automatically update summary values when data is edited, added, or removed.
platform: grid-sdk
...
{% include code-snippet/grid-sdk/asp-net-mvc/grid/aggregate/reactive-agg-batch-edit/razor %}
{% endhighlight %}
{% highlight c# tabtitle="reactive-aggregate-batch-edit.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/aggregate/reactive-agg-batch-edit/reactive-aggregate-batch-edit.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/aggregate/reactive-agg-inline-edit/razor %}
{% endhighlight %}
{% highlight c# tabtitle="reactive-aggregate-inline-edit.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/aggregate/reactive-agg-inline-edit/reactive-aggregate-inline-edit.cs %}
{% endhighlight %}
{% endtabs %}
