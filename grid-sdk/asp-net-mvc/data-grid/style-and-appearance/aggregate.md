---
layout: post
title: ASP.NET MVC Grid Aggregate Customization | Syncfusion
description: Learn how to customize aggregate styles in ASP.NET MVC Data Grid with aggregate rows, cells, templates, and visual formatting options.
platform: grid-sdk
control: Aggregate
...
# Aggregate Style in ASP.NET MVC Data Grid
