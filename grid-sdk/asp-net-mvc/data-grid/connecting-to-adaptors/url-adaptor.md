---
layout: post
title: ASP.NET MVC Grid Bind Data with UrlAdaptor | Syncfusion
description: Learn how to bind remote data from custom REST APIs in ASP.NET MVC Data Grid and perform data operations and CRUD actions.
platform: grid-sdk
control: Grid
