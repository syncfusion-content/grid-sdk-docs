---
layout: post
title: ASP.NET MVC Grid Row Selection | Syncfusion
description: Learn how to select single or multiple rows in ASP.NET MVC Data Grid with selection modes, keyboard interactions, selection APIs, and row selection events.
platform: grid-sdk
