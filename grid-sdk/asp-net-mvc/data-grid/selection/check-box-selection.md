...
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/checkbox-selection/razor %}
{% endhighlight %}
{% highlight c# tabtitle="checkbox.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/checkbox-selection/checkbox.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/checkbox-mode/razor %}
{% endhighlight %}
{% highlight c# tabtitle="checkbox.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/checkbox-mode/checkbox.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/checkbox-hide/razor %}
{% endhighlight %}
{% highlight c# tabtitle="checkbox.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/checkbox-hide/checkbox.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/prevent-checkbox-selection/razor %}
{% endhighlight %}
{% highlight c# tabtitle="checkbox.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/prevent-checkbox-selection/checkbox.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/checkbox-select/razor %}
{% endhighlight %}
{% highlight c# tabtitle="checkbox.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/checkbox-select/checkbox.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/checkbox-only/razor %}
{% endhighlight %}
{% highlight c# tabtitle="checkbox.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/checkbox-only/checkbox.cs %}
{% endhighlight %}
{% endtabs %}
