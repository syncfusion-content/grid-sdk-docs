...
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/cell-single-selection/razor %}
{% endhighlight %}
{% highlight c# tabtitle="cell-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/cell-single-selection/cell-selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/cell-multiple-selection/razor %}
{% endhighlight %}
{% highlight c# tabtitle="cell-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/cell-multiple-selection/cell-selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/cell-mode/razor %}
{% endhighlight %}
{% highlight c# tabtitle="cell-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/cell-mode/cell-selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/cell-single-method/razor %}
{% endhighlight %}
{% highlight c# tabtitle="cell-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/cell-single-method/cell-selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/cell-multiple-method/razor %}
{% endhighlight %}
{% highlight c# tabtitle="cell-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/cell-multiple-method/cell-selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/cell-range-selection/razor %}
{% endhighlight %}
{% highlight c# tabtitle="cell-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/cell-range-selection/cell-selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/cell-get-selected/razor %}
{% endhighlight %}
{% highlight c# tabtitle="cell-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/cell-get-selected/cell-selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/cell-clear-selection/razor %}
{% endhighlight %}
{% highlight c# tabtitle="cell-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/cell-clear-selection/cell-selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/cell-events/razor %}
{% endhighlight %}
{% highlight c# tabtitle="cell-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/cell-events/cell-selection.cs %}
{% endhighlight %}
{% endtabs %}
