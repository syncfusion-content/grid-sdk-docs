...
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/selection/razor %}
{% endhighlight %}
{% highlight c# tabtitle="selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/selection/selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/selection-mode/razor %}
{% endhighlight %}
{% highlight c# tabtitle="selection-mode.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/selection-mode/selection-mode.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/toggleselection/razor %}
{% endhighlight %}
{% highlight c# tabtitle="toggleselection.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/toggleselection/toggleselection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/selection-clear/razor %}
{% endhighlight %}
{% highlight c# tabtitle="selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/selection-clear/selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/selection-persist/razor %}
{% endhighlight %}
{% highlight c# tabtitle="selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/selection/selection-persist/selection.cs %}
{% endhighlight %}
{% endtabs %}
