---
layout: post
title: ASP.NET MVC Grid Accessibility | Syncfusion
description: Learn how to use accessibility features in ASP.NET MVC Data Grid with keyboard navigation, ARIA attributes, screen reader support, and accessibility standards.
platform: grid-sdk
...
{% include code-snippet/grid-sdk/asp-net-mvc/grid/accessibility/prevent-key/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Accessibility.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/accessibility/prevent-key/prevent-key.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/grid-sdk/asp-net-mvc/grid/accessibility/prevent-key/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Accessibility.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/accessibility/prevent-key/prevent-key.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/accessibility/shortcut-key/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Accessibility.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/accessibility/shortcut-key/shortcut-key.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/accessibility/shortcut-key/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Accessibility.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/accessibility/shortcut-key/shortcut-key.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/accessibility/ensuring-accessibility/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Accessibility.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/accessibility/ensuring-accessibility/ensuring-accessibility.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/accessibility/ensuring-accessibility/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Accessibility.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/accessibility/ensuring-accessibility/ensuring-accessibility.cs %}
{% endhighlight %}
