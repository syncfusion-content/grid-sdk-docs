...
Match the ASP.NET MVC Data Grid to the application's visual design using [built-in themes](./style-and-appearance/style-and-appearance) and customization options. Supported themes are:
