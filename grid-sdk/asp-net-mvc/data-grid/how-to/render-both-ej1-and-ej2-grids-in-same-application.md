---
layout: post
title: ASP.NET MVC Grid EJ1 and EJ2 Integration | Syncfusion
description: Learn how to run EJ1 and EJ2 Grids in the same ASP.NET MVC application by resolving library conflicts and configuring compatibility.
platform: grid-sdk
...
# Render EJ1 and EJ2 Grids in ASP.NET MVC Data Grid
