...
{% include code-snippet/grid-sdk/asp-net-mvc/grid/data-binding/remote-custom-handle/razor %}
{% endhighlight %}
{% highlight c# tabtitle="HomeController.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/data-binding/remote-custom-handle/custombinding.cs %}
{% endhighlight %}
{% highlight c# tabtitle="OrdersDetails.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/data-binding/remote-custom-handle/OrdersDetails.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/grid-sdk/asp-net-mvc/grid/data-binding/remote-export/razor %}
{% endhighlight %}
{% highlight c# tabtitle="remotedata.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/data-binding/remote-export/remotedatamvc.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/data-binding/remote-prams/razor %}
{% endhighlight %}
{% highlight c# tabtitle="remotedata.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/data-binding/remote-prams/custombinding.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/data-binding/offline/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Offline.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/data-binding/offline/offline.cs %}
{% endhighlight %}
{% endtabs %} 
