---
layout: post
title: ASP.NET MVC Grid Column Menu | Syncfusion
description: Learn how to configure and customize the column menu in ASP.NET MVC Data Grid, including sorting, filtering, menu items, and column-specific actions.
platform: grid-sdk
control: Column Menu
