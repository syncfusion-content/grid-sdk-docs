---
layout: post
title: ASP.NET MVC Grid Column Template| Syncfusion
description: Learn how to create custom column templates in ASP.NET MVC Data Grid to render rich cell content, editors, formatting, and interactive UI elements.
platform: grid-sdk
...
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/template/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Template.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/template/template.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/column-template-hyperlink/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Template.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/column-template-hyperlink/column-template-hyperlink.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/column-template-linechart/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Template.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/column-template-linechart/column-template-linechart.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/column-template-colorpicker/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Template.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/column-template-colorpicker/column-template-colorpicker.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/column-template-dropdownlist/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Template.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/column-template-dropdownlist/column-template-dropdownlist.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/column-template-chip/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Template.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/column-template-chip/column-template-chip.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/column-template-progressbar/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Template.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/column-template-progressbar/column-template-progressbar.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/column-template-radiobutton/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Template.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/column-template-radiobutton/column-template-radiobutton.cs %}
{% endhighlight %}
{% highlight c# tabtitle="OrdersDetails.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/column-template-radiobutton/OrdersDetails.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/condition-template/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Template.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/condition-template/template.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/row-object/razor %}
{% endhighlight %}
{% highlight c# tabtitle="row-object.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/row-object/row-object.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/column-template-customhelper/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Template.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/column-template-customhelper/column-template-customhelper.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/column-template-adding-dynamically/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Template.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/column-template-adding-dynamically/column-tempate-adding-dynamically.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/template-aria-label/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Template.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/columns/template-aria-label/template-aria-label.cs %}
{% endhighlight %}
{% endtabs %}