---
layout: post
title: ASP.NET MVC Grid Cells | Syncfusion
description: Learn how to customize ASP.NET MVC Data Grid cells with HTML content, text wrapping, cell styling, clip modes, tooltips, and grid line configuration.
platform: grid-sdk
control: Cell
...
{% include code-snippet/grid-sdk/asp-net-mvc/grid/cell/display-html-content/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Html.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/cell/display-html-content/html.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/cell/autowrap/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Autowrap.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/cell/autowrap/autowrap.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/cell/customize-cell-cs1/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Html.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/cell/customize-cell-cs1/customize.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/cell/customize-cell-cs2/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Html.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/cell/customize-cell-cs2/customize.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/cell/customize-cell-cs3/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Html.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/cell/customize-cell-cs3/customize.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/cell/customize-cell-cs4/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Html.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/cell/customize-cell-cs4/customize.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/grid-sdk/asp-net-mvc/grid/cell/clipmode/razor %}
{% endhighlight %}c
{% highlight c# tabtitle="Clipmode.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/cell/clipmode/clipmode.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/cell/tooltip/razor %}
{% endhighlight %}
{% highlight c# tabtitle="tooltip.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/cell/tooltip/tooltip.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/cell/custom-tooltip/razor %}
{% endhighlight %}
{% highlight c# tabtitle="tooltip.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/cell/custom-tooltip/tooltip.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/cell/gridlines/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Gridlines.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/cell/gridlines/gridlines.cs %}
{% endhighlight %}
{% endtabs %}
