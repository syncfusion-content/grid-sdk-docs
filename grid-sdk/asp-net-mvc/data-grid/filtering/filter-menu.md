---
layout: post
title: ASP.NET MVC Grid Filter Menu | Syncfusion
description: Learn how to use Filter Menu in ASP.NET MVC Data Grid with configurable dialogs, custom components, operator options, and multi-value filtering.
platform: grid-sdk
control: Filter Menu
...
{% include code-snippet/grid-sdk/asp-net-mvc/grid/filtering/filtermenu/razor %}
{% endhighlight %}
{% highlight c# tabtitle="filtermenu.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/filtering/filtermenu/filtermenu.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/filtering/filter-menu-component/razor %}
{% endhighlight %}
{% highlight c# tabtitle="filtermenu.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/filtering/filter-menu-component/filtermenu.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/filtering/filter-menu-format/razor %}
{% endhighlight %}
{% highlight c# tabtitle="filtermenu.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/filtering/filter-menu-format/filtermenu.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/filtering/filter-menu-operators/razor %}
{% endhighlight %}
{% highlight c# tabtitle="filtermenu.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/filtering/filter-menu-operators/filtermenu.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/filtering/filter-menu-multiple-keywords/razor %}
{% endhighlight %}
{% highlight c# tabtitle="filtermenu.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/filtering/filter-menu-multiple-keywords/filtermenu.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/filtering/filter-menu-menu-dialog/razor %}
{% endhighlight %}
{% highlight c# tabtitle="filtermenu.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/filtering/filter-menu-menu-dialog/filtermenu.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/filtering/filter-menu-hide-method/razor %}
{% endhighlight %}
{% highlight c# tabtitle="filtermenu.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/filtering/filter-menu-hide-method/filtermenu.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/filtering/filter-menu-events/razor %}
{% endhighlight %}
{% highlight c# tabtitle="filtermenu.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/filtering/filter-menu-events/filtermenu.cs %}
{% endhighlight %}
{% endtabs %}
