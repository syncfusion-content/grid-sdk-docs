---
layout: post
title: ASP.NET MVC Grid MySQL Server Integration | Syncfusion
description: Learn how to connect ASP.NET MVC Data Grid to MySQL Server using LINQ2DB, execute database queries, and manage grid data efficiently.
platform: grid-sdk
control: grid
