...
{% include code-snippet/grid-sdk/asp-net-mvc/grid/row/row-span/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Span.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/row/row-span/row-span.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/row/row-spanning/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Span.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/row/row-spanning/row-span.cs %}
{% endhighlight %}
{% endtabs %}
