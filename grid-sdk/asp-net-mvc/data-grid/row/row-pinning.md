---
layout: post
title: ASP.NET MVC Grid Row Pinning | Syncfusion
description: Learn how to pin rows in ASP.NET MVC Data Grid using Syncfusion. Keep important rows fixed at the top while supporting data operations.
platform: grid-sdk
control: Row Pinning
...
{% include code-snippet/grid-sdk/asp-net-mvc/grid/row/row-pinning-cs1/razor %}
{% endhighlight %}
{% highlight c# tabtitle="row-pinning.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/row/row-pinning-cs1/row-pinning.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/row/row-pinning-cs2/razor %}
{% endhighlight %}
{% highlight c# tabtitle="row-pinning.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/row/row-pinning-cs2/row-pinning.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/row/row-pinning-cs3/razor %}
{% endhighlight %}
{% highlight c# tabtitle="row-pinning.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/row/row-pinning-cs3/row-pinning.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/row/row-pinning-cs4/razor %}
{% endhighlight %}
{% highlight c# tabtitle="row-pinning.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/row/row-pinning-cs4/row-pinning.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/row/row-pinning-cs5/razor %}
{% endhighlight %}
{% highlight c# tabtitle="row-pinning.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/row/row-pinning-cs5/row-pinning.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/row/row-pinning-cs6/razor %}
{% endhighlight %}
{% highlight c# tabtitle="row-pinning.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/grid/row/row-pinning-cs6/row-pinning.cs %}
{% endhighlight %}
{% endtabs %}
