...
## Perform single-click batch editing via events
...
The Data Grid supports Undo / Redo actions in batch editing, allowing changes such as cell edits, row additions, and row deletions to be reverted or reapplied before saving. This feature can be enabled by setting the `GridEditSettings.EnableUndoRedo` property to `true`.
...
* [Editing in Blazor Data Grid](./editing.md)
* [Editing types](./edit-types.md)
* [Validation](./column-validation.md)
* [Data Grid events in Blazor](./events.md)
