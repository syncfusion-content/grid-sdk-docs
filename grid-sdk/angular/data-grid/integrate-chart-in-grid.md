...
{% include code-snippet/grid-sdk/angular/grid/chart-intergration-cs1/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="app.component.html" %}
{% include code-snippet/grid-sdk/angular/grid/chart-intergration-cs2/src/app.component.html %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/grid-sdk/angular/grid/chart-intergration-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/grid-sdk/angular/grid/chart-intergration-cs2/src/app.component.ts %}
{% endhighlight %}
...
{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/grid-sdk/angular/grid/chart-intergration-cs2/src/main.ts %}
{% endhighlight %}
{% endtabs %}
