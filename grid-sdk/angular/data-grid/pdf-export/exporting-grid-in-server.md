...
{% include code-snippet/grid-sdk/angular/grid/passing-parameters-on-server/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/grid-sdk/angular/grid/passing-parameters-on-server/src/main.ts %}
{% endhighlight %}
{% endtabs %}
