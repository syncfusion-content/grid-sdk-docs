...
{% include code-snippet/grid-sdk/angular/grid/custom-cell-cs9/src/app.component.ts %}
{% endhighlight %}
...
{% include code-snippet/grid-sdk/angular/grid/custom-cell-cs9/src/main.ts %}
{% endhighlight %}
{% endtabs %}
...
{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/grid-sdk/angular/grid/custom-cell-cs10/src/main.ts %}
{% endhighlight %}
{% endtabs %}
...
{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/grid-sdk/angular/grid/row-template-cs3/src/main.ts %}
{% endhighlight %}
{% endtabs %}
...
{% endhighlight %}
{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/grid-sdk/angular/grid/row-chart-template/src/main.ts %}
{% endhighlight %}
{% endtabs %}
