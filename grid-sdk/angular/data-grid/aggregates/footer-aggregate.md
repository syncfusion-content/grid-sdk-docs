...
{% include code-snippet/grid-sdk/angular/grid/aggregates-footer-cs1/src/app.component.ts %}
{% endhighlight %}
...
{% include code-snippet/grid-sdk/angular/grid/aggregates-footer-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/grid-sdk/angular/grid/aggregates-footer-cs2/src/app.component.ts %}
{% endhighlight %}
{% highlight ts tabtitle="app.template.html" %}
{% raw %}
<ejs-grid [dataSource]="data" height="210px">
...
{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/grid-sdk/angular/grid/aggregates-footer-cs2/src/main.ts %}
{% endhighlight %}
{% endtabs %}
...
{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/grid-sdk/angular/grid/aggregates-footer-cs3/src/main.ts %}
{% endhighlight %}
{% endtabs %}
