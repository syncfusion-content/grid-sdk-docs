...
{% include code-snippet/grid-sdk/angular/grid/custom-helper-loop-template/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/grid-sdk/angular/grid/custom-helper-loop-template/src/main.ts %}
{% endhighlight %}
{% endtabs %}
