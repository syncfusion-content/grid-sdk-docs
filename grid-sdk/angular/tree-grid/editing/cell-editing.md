...
{% include code-snippet/grid-sdk/angular/treegrid/edit-toolbar-cs7/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/grid-sdk/angular/treegrid/edit-toolbar-cs7/src/main.ts %}
{% endhighlight %}
{% endtabs %}
