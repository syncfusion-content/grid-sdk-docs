...
{% include code-snippet/grid-sdk/angular/treegrid/excel-export-cs1/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/grid-sdk/angular/treegrid/excel-export-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
