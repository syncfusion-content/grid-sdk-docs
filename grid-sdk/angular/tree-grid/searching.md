...
To clear active search results, set [searchSettings.key](https://ej2.syncfusion.com/angular/documentation/api/treegrid/searchSettings#key) to an empty string using an external button, or use the built-in clear icon in the search field.
