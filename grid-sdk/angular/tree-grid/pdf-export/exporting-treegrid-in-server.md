...
{% include code-snippet/grid-sdk/angular/treegrid/refresh-cs19/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/grid-sdk/angular/treegrid/refresh-cs19/src/main.ts %}
{% endhighlight %}
{% endtabs %}
