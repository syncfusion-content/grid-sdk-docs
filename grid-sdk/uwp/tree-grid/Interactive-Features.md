...
description: Add interactive features in the Syncfusion® UWP TreeGrid control. Supports context menus for nodes, rows, headers, and expanders with customization options.
platform: grid-sdk
control: SfTreeGrid
documentation: ug
---
