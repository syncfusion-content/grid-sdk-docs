...
description: Add checkboxes to nodes in the Syncfusion® UWP TreeGrid control. Supports selecting, toggling, and customizing node check states for hierarchical data.
platform: grid-sdk
control: SfTreeGrid
documentation: ug
---
