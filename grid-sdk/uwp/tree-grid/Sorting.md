...
description: Sort data in the Syncfusion® UWP TreeGrid control with support for single and multi‑column sorting, custom comparers, and interactive sort icons.
platform: grid-sdk
control: SfTreeGrid
documentation: ug
---
