---
layout: post
title: Sorting in UWP Pivot Table | Syncfusion®
description: Sorting in Syncfusion® UWP Pivot Table control helps users organize data efficiently using built‑in comparers, custom comparers, or SortOption values.
platform: grid-sdk
control: Pivot Table
documentation: ug
---
