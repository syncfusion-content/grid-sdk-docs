---
layout: post
title: Hiding Subtotals in UWP Pivot Table | Syncfusion®
description: Hide subtotals in Syncfusion® UWP Pivot Table control by disabling row, column, or specific item subtotals for a cleaner and more focused data view.
platform: grid-sdk
control: Pivot Table
documentation: ug
---
