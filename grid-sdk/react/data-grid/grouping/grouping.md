...
description: Learn how to use grouping in React Data Grid with configurable settings, aggregates, drop area control, reorderable columns, and expand or collapse options.
control: Grouping 
platform: grid-sdk
documentation: ug
