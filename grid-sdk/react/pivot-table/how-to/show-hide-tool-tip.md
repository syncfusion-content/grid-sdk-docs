---
layout: post
title: How to show or hide tooltip in React Pivot Table | Syncfusion
description: Step-by-step example showing how to show or hide the tooltip in the React Pivot Table using the showTooltip property.
control: Pivot Table
platform: ej2-react
documentation: ug
domainurl: ##DomainURL##
...
{% include code-snippet/grid-sdk/react/pivot-table/default-cs169/app/App.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="App.tsx" %}
{% include code-snippet/grid-sdk/react/pivot-table/default-cs169/app/App.tsx %}
{% endhighlight %}
{% endtabs %}

{% previewsample "https://help.syncfusion.com/code-snippet/grid-sdk/react/pivot-table/default-cs169" %}
