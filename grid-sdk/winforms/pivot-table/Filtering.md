---
layout: post
title: Filtering in Windows Forms Pivot Table | Syncfusion®
description: Apply filtering in Syncfusion® Windows Forms Pivot Table control to refine data views using filter expressions or grouping bar with multiple conditions.
platform: grid-sdk
control: Pivot Table
documentation: ug
---

# Filtering in Windows Forms Pivot Table
