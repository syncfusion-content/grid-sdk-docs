---
layout: post
title: How to Bind Pivot Table with Chart in Windows Forms | Syncfusion®
description: Bind Pivot Table with Chart in Syncfusion® Windows Forms control using PivotGridChartHelper, customize chart styles, and persist series type at runtime.
platform: grid-sdk
control: Pivot Table
documentation: ug
---
