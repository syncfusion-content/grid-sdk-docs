---
layout: post
title: Row Height and Column Width in Windows Forms Pivot Table | Syncfusion®
description: Change row height and column width in Syncfusion® Windows Forms Pivot Table control using RowHeights and ColWidths properties with code examples.
platform: grid-sdk
control: Pivot Table
documentation: ug
---
