---
layout: post
title: Pivot Rows in Windows Forms Pivot Table | Syncfusion®
description: Define and manage pivot rows in Syncfusion® Windows Forms Pivot Table control using PivotItem with support for synchronization, sorting, and formatting.
platform: grid-sdk
control: Pivot Table
documentation: ug
---

# Pivot Rows in Windows Forms Pivot Table
