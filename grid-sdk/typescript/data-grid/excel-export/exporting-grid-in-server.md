---
layout: post
title: Typescript Grid Server-Side Excel Export | Syncfusion
description: Learn how to export Typescript Data Grid data on the server, generate Excel workbooks in the backend, and handle large-scale exports efficiently.
platform: grid-sdk
...
# Server-Side Excel Export in Typescript Data Grid
