---
layout: post
title: MySQL Server Data Binding in Syncfusion TypeScript Grid
description: Learn how to consume data from SQL Server using MySQL Client, bind it to Syncfusion TypeScript Grid, and perform CRUD operations.
platform: grid-sdk
control: grid
...
# Connecting MySQL Server data to Syncfusion TypeScript Grid
...
This section describes step by step process how to retrieve data from a MySQL Server using an API service and bind it to the Syncfusion TypeScript Grid.
...
This section describes step by step process how to retrieve data from a MySQL Server using [CustomAdaptor](https://ej2.syncfusion.com/angular/documentation/grid/connecting-to-adaptors/custom-adaptor) and bind it to the Syncfusion TypeScript Grid.
