...
This section describes step by step process how to retrieve data from a Microsoft SQL Server using an API service and bind it to the Syncfusion TypeScript Grid.
...
This section describes step by step process how to retrieve data from a Microsoft SQL Server using `CustomAdaptor` and bind it to the Syncfusion TypeScript Grid.
...
Let’s see how to perform CRUD operation using Microsoft SQL Server data with Syncfusion TypeScript Grid.
