---
layout: post
title: Typescript Grid Column Menu | Syncfusion
description: Learn how to configure and customize the column menu in Typescript Data Grid, including sorting, filtering, menu items, and column-specific actions.
platform: grid-sdk
control: Column menu 
...
# Column Menu in Typescript Data Grid
