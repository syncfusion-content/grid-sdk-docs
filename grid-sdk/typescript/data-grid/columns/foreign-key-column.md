---
layout: post
title: Typescript Grid Foreign Key Column | Syncfusion
description: Learn how to use foreign key columns in Typescript Data Grid to map related data, display associated values, and bind local or remote data sources.
platform: grid-sdk
...
# Foreign Key Column in Typescript Data Grid
