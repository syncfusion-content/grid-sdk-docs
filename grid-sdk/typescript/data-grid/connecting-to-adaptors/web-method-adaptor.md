...
description: Learn how to use WebMethodAdaptor in Typescript Data Grid to bind remote data, execute CRUD operations, and integrate web methods efficiently.
platform: grid-sdk
control: grid
...
This section describes a step-by-step process for retrieving data using WebMethodAdaptor, then binding it to the TypeScript Grid control to facilitate data and CRUD operations.
