---
layout: post
title: Typescript Grid Server-Side PDF Export | Syncfusion
description: Learn how to export Typescript Data Grid data using server-side PDF generation, API endpoints, and efficient export processing for large datasets.
platform: grid-sdk
...
# Server dependencies in Typescript Data Grid
