---
layout: post
title: Typescript Grid Aggregates | Syncfusion
description: Learn how to use aggregates in Typescript Data Grid to display column summaries, footer and group aggregates, and create custom aggregate calculations.
platform: grid-sdk
control: Aggregates 
...
# Aggregates in Typescript Data Grid
