...
description: Learn here all about Microsoft sql server in Syncfusion JavaScript Pivot Table control of Syncfusion Essential JS 2 and more.
platform: grid-sdk
...
# Microsoft SQL server in JavaScript Pivot Table control
