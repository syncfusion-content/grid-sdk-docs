---
layout: post
title: Javascript Grid Aggregate Customization | Syncfusion
description: Learn how to customize aggregate styles in Javascript Data Grid with aggregate rows, cells, templates, and visual formatting options.
platform: grid-sdk
control: Aggregate 
...
# Aggregate Style in Javascript Data Grid

You can customize the appearance of aggregate elements in the JavaScript Grid control using CSS. Below are examples of how to customize the aggregate root element and the aggregate cell elements.
