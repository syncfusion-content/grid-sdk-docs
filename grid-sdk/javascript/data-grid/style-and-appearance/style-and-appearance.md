---
layout: post
title: Javascript Grid Style and Appearance | Syncfusion
description: Learn how to customize the style and appearance of Javascript Data Grid with built-in themes, CSS customization, theme packages, and design configuration.
platform: grid-sdk
...
# Style and Appearance in Javascript Data Grid
...
{% include code-snippet/grid-sdk/javascript/grid/style-appearance-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/grid-sdk/javascript/grid/style-appearance-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/grid-sdk/javascript/grid/style-appearance-cs1" %}

{% elsif page.publishingplatform == "javascript" %}

{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/grid-sdk/javascript/grid/style-appearance-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/grid-sdk/javascript/grid/style-appearance-cs1/index.html %}
{% endhighlight %}
