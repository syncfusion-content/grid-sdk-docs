...
{% if page.publishingplatform == "typescript" %}
  {% tabs %}
    ...
    {% include code-snippet/grid-sdk/javascript/grid/remote-custom-binding/app.ts %}
    {% endhighlight %}
    {% highlight html tabtitle="index.html" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-custom-binding/index.html %}
    {% endhighlight %}
    {% highlight css tabtitle="styles.css" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-custom-binding/styles.css %}
    {% endhighlight %}
    {% highlight ts tabtitle="server.ts" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-custom-binding/server.ts %}
    {% endhighlight %}
    {% highlight ts tabtitle="orderService.ts" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-custom-binding/orderService.ts %}
    {% endhighlight %}
    {% highlight ts tabtitle="datasource.ts" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-custom-binding/datasource.ts %}
    {% endhighlight %}
  {% endtabs %}
{% elsif page.publishingplatform == "javascript" %}
  {% tabs %}
    {% highlight js tabtitle="index.js" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-custom-binding2/index.js %}
    {% endhighlight %}
    {% highlight html tabtitle="index.html" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-custom-binding2/index.html %}
    {% endhighlight %}
    {% highlight js tabtitle="server.js" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-custom-binding2/server.js %}
    {% endhighlight %}
    {% highlight js tabtitle="orderService.js" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-custom-binding2/orderService.js %}
    {% endhighlight %}
    {% highlight js tabtitle="datasource.js" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-custom-binding2/datasource.js %}
    {% endhighlight %}
  {% endtabs %}
{% endif %}
...
{% if page.publishingplatform == "typescript" %}
  {% tabs %}
    {% highlight ts tabtitle="app.ts" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-custom-export/app.ts %}
    {% endhighlight %}
    {% highlight html tabtitle="index.html" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-custom-export/index.html %}
    {% endhighlight %}
    {% highlight css tabtitle="styles.css" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-custom-export/styles.css %}
    {% endhighlight %}
    {% highlight ts tabtitle="server.ts" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-custom-export/server.ts %}
    {% endhighlight %}
    {% highlight ts tabtitle="orderService.ts" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-custom-export/orderService.ts %}
    {% endhighlight %}
    {% highlight ts tabtitle="datasource.ts" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-custom-export/datasource.ts %}
    {% endhighlight %}
  {% endtabs %}
{% elsif page.publishingplatform == "javascript" %}
  {% tabs %}
    {% highlight js tabtitle="index.js" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-custom-export2/index.js %}
    {% endhighlight %}
    {% highlight html tabtitle="index.html" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-custom-export2/index.html %}
    {% endhighlight %}
    {% highlight js tabtitle="server.js" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-custom-export2/server.js %}
    {% endhighlight %}
    {% highlight js tabtitle="orderService.js" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-custom-export2/orderService.js %}
    {% endhighlight %}
    {% highlight js tabtitle="datasource.js" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-custom-export2/datasource.js %}
    {% endhighlight %}
  {% endtabs %}
{% endif %}
...
{% if page.publishingplatform == "typescript" %}
  {% tabs %}
    {% highlight ts tabtitle="app.ts" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-add-params/app.ts %}
    {% endhighlight %}
    {% highlight html tabtitle="index.html" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-add-params/index.html %}
    {% endhighlight %}
    {% highlight css tabtitle="styles.css" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-add-params/styles.css %}
    {% endhighlight %}
    {% highlight ts tabtitle="server.ts" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-add-params/server.ts %}
    {% endhighlight %}
    {% highlight ts tabtitle="orderService.ts" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-add-params/orderService.ts %}
    {% endhighlight %}
    {% highlight ts tabtitle="datasource.ts" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-add-params/datasource.ts %}
    {% endhighlight %}
  {% endtabs %}
{% elsif page.publishingplatform == "javascript" %}
  {% tabs %}
    {% highlight js tabtitle="index.js" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-add-params2/index.js %}
    {% endhighlight %}
    {% highlight html tabtitle="index.html" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-add-params2/index.html %}
    {% endhighlight %}
    {% highlight js tabtitle="server.js" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-add-params2/server.js %}
    {% endhighlight %}
    {% highlight js tabtitle="orderService.js" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-add-params2/orderService.js %}
    {% endhighlight %}
    {% highlight js tabtitle="datasource.js" %}
    {% include code-snippet/grid-sdk/javascript/grid/remote-add-params2/datasource.js %}
    {% endhighlight %}
  {% endtabs %}
{% endif %}
...
{% include code-snippet/grid-sdk/javascript/grid/grid-cs16/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/grid-sdk/javascript/grid/grid-cs16/index.html %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/grid-sdk/javascript/grid/grid-cs16" %}

{% elsif page.publishingplatform == "javascript" %}

{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/grid-sdk/javascript/grid/grid-cs16/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/grid-sdk/javascript/grid/grid-cs16/index.html %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/grid-sdk/javascript/grid/fetch-datamanger/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/grid-sdk/javascript/grid/fetch-datamanger/index.html %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/grid-sdk/javascript/grid/fetch-datamanger" %}

{% elsif page.publishingplatform == "javascript" %}

{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/grid-sdk/javascript/grid/fetch-datamanger/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/grid-sdk/javascript/grid/fetch-datamanger/index.html %}
{% endhighlight %}
