---
layout: post
title: JavaScript TreeGrid Custom Toolbar | Syncfusion
description: Learn how to add and configure custom toolbars in the JavaScript TreeGrid, including event handling, alignment, and mixing with built-in items.
platform: grid-sdk
...
# Custom Toolbar in JavaScript TreeGrid
