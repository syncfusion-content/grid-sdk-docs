---
layout: post
title: JavaScript TreeGrid Data Binding | Syncfusion
description: Learn about data binding in the JavaScript TreeGrid, covering local and remote data integration, expand state mapping, and best practices.
platform: grid-sdk
...
# Data Binding in JavaScript TreeGrid
...
{% include code-snippet/grid-sdk/javascript/treegrid/data-binding-cs1/index.ts %}
{% endhighlight %}
{% highlight ts tabtitle="datasource.ts" %}
{% include code-snippet/grid-sdk/javascript/treegrid/data-binding-cs1/datasource.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/grid-sdk/javascript/treegrid/data-binding-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/grid-sdk/javascript/treegrid/data-binding-cs1" %}

{% elsif page.publishingplatform == "javascript" %}

{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/grid-sdk/javascript/treegrid/data-binding-cs1/index.js %}
{% endhighlight %}
{% highlight js tabtitle="datasource.js" %}
{% include code-snippet/grid-sdk/javascript/treegrid/data-binding-cs1/es5-datasource.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/grid-sdk/javascript/treegrid/data-binding-cs1/index.html %}
{% endhighlight %}
