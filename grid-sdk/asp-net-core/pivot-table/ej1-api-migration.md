---
layout: post
title: Ej1 Api Migration in ASP.NET Core Pivot Table Component
description: Learn here all about Ej1 Api Migration in Syncfusion ASP.NET Core Pivot Table component of Syncfusion Essential JS 2 and more.
platform: grid-sdk
