---
layout: post
title: Immutable mode in ASP.NET Core Treegrid control | Syncfusion
description: Learn here all about Immutable mode in Syncfusion ASP.NET Core Treegrid control of Syncfusion Essential JS 2 and more.
platform: grid-sdk
...
# Immutable Mode in ASP.NET Core TreeGrid
