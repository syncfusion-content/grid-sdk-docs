---
layout: post
title: ASP.NET Core TreeGrid Excel Export | Syncfusion
...
{% include code-snippet/grid-sdk/asp-net-core/tree-grid/excel-export/export/tagHelper %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/tree-grid/excel-export/is-collapsed/tagHelper %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/tree-grid/excel-export/custom-aggregate-excel/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="empty-record-template.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/tree-grid/excel-export/custom-aggregate-excel/custom-aggregate-excel.cs %}
{% endhighlight %}
{% endtabs %}
