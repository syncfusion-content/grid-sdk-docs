---
layout: post
title: ASP.NET Core TreeGrid Context Menu | Syncfusion
description: Learn how to customize the context menu in ASP.NET Core TreeGrid, including custom items, dynamic enable/disable options, and API integration.
platform: grid-sdk
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/tree-grid/contextmenu/custom-contextmenu/tagHelper %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/tree-grid/contextmenu/enable-contextmenu/tagHelper %}
{% endhighlight %}
