---
layout: post
title: ASP.NET Core TreeGrid Edit Types | Syncfusion
...
# Edit Types in ASP.NET Core TreeGrid
...
{% include code-snippet/grid-sdk/asp-net-core/tree-grid/editing/edit-type/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="EditType.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/tree-grid/editing/edit-type/editType.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/grid-sdk/asp-net-core/tree-grid/editing/edit-type/razor %}
{% endhighlight %}
{% highlight c# tabtitle="EditType.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/tree-grid/editing/edit-type/editType.cs %}
{% endhighlight %}
