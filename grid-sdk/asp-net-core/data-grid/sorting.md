---
layout: post
title: ASP.NET Core Grid Sorting | Syncfusion
description: Learn how to use Sorting in ASP.NET Core Data Grid to sort data by one or more columns, customize sorting behavior, and control sort indicators.
platform: grid-sdk
control: Sorting
...
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/sorting/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="sorting.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/sorting/sorting.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/initial-sort/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="initial-sort.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/initial-sort/initial-sort.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/multi-column-sort/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="multi-column-sort.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/multi-column-sort/multi-column-sort.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/sorting-prevent/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="sorting.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/sorting-prevent/sorting.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/sorting-compare/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="sorting.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/sorting-compare/sorting.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/sort-comparer/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="sort-comparer.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/sort-comparer/sort-comparer.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/foreign-sort-local/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="foreign-sort.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/foreign-sort-local/foreign-sort.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/foreign-sort-remote/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="foreign-sort" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/foreign-sort-remote/foreign-sortcore.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/sorting-sort-currency/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="sorting.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/sorting-sort-currency/sorting.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/sort-customize/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="sort-custom.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/sort-customize/sort-custom.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/sorting-sort-column/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="sorting.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/sorting-sort-column/sorting.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/sorting-sort-remove/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="sorting.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/sorting-sort-remove/sorting.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/sorting-sort-clear/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="sorting.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/sorting-sort-clear/sorting.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/sort-event/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="sort-event.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/sorting/sort-event/sort-event.cs %}
{% endhighlight %}
{% endtabs %}
