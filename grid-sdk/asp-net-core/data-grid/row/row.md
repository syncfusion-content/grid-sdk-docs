...
{% include code-snippet/grid-sdk/asp-net-core/grid/row/row-style-event/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Style.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/row-style-event/event-style.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/style-alt-row/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Style-alt-row.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/style-alt-row/style-alt-row.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/select-row/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Select-row.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/select-row/select-row.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/row-style-method/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Style.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/row-style-method/style.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/row-height/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Row-height.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/row-height/row-height.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/particluar-row-height/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Particular-row-height.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/particluar-row-height/row-height.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/row-hover/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Hover.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/row-hover/hover.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/row-info/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Row-info.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/row-info/row-info.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/frozen-rows/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Frozen.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/frozen-rows/frozen.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/frozen-rows-style/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Frozen.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/frozen-rows-style/frozen.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/add-row/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Add-row.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/add-row/add-row.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/show-hide-row/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Show-hide-row.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/show-hide-row/show-hide-row.cs %}
{% endhighlight %}
{% endtabs %}
