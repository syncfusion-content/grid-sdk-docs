---
layout: post
title: ASP.NET Core Grid Row Pinning | Syncfusion
description: Learn how to pin rows in ASP.NET Core Data Grid using Syncfusion. Keep important rows fixed at the top while supporting data operations.
platform: grid-sdk
control: Row Pinning
...
{% include code-snippet/grid-sdk/asp-net-core/grid/row/row-pinning-cs1/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="row-pinning.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/row-pinning-cs1/row-pinning.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/row-pinning-cs2/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="row-pinning.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/row-pinning-cs2/row-pinning.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/row-pinning-cs3/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="row-pinning.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/row-pinning-cs3/row-pinning.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/row-pinning-cs4/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="row-pinning.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/row-pinning-cs4/row-pinning.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/row-pinning-cs5/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="row-pinning.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/row-pinning-cs5/row-pinning.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/row-pinning-cs6/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="row-pinning.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/row/row-pinning-cs6/row-pinning.cs %}
{% endhighlight %}
{% endtabs %}
