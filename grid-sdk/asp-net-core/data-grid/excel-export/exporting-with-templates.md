...
{% include code-snippet/grid-sdk/asp-net-core/grid/excel-export/column-template-export/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="column-template-export.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/excel-export/column-template-export/column-template-export.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/excel-export/detail-template-export/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="detail-template-export.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/excel-export/detail-template-export/detail-template-export.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/excel-export/caption-template-export/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="caption-template-export.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/excel-export/caption-template-export/caption-template-export.cs %}
{% endhighlight %}
{% endtabs %}
