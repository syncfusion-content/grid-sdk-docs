...
{% include code-snippet/grid-sdk/asp-net-core/grid/state-persist/state-changing-id/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="persist.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/state-persist/state-changing-id/persist.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/state-persist/clearing-local-storage/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="local-storage.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/state-persist/clearing-local-storage/local-storage.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/state-persist/state-state-version/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="state-version.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/state-persist/state-state-version/state-version.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/state-persist/state-previous-state/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="previous-state.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/state-persist/state-previous-state/previous-state.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/state-persist/state-custom-query/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="custom-query.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/state-persist/state-custom-query/custom-query.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/state-persist/observable/tagHelper %}
{% endhighlight %}

{% highlight c# tabtitle="observable.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/state-persist/observable/observable.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/state-persist/state-prevent/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="state-prevent.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/state-persist/state-prevent/state-prevent.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/state-persist/column-add/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="column-add.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/state-persist/column-add/column-add.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/state-persist/column-persist/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="persist.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/state-persist/column-persist/persist.cs %}
{% endhighlight %}
{% endtabs %}
