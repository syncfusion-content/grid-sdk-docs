---
layout: post
title: ASP.NET Core Grid Empty Record Template | Syncfusion
description: Learn how to customize the empty record template in ASP.NET Core Data Grid to display custom messages, images, or actions when no data is available.
platform: grid-sdk
