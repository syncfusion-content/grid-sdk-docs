---
layout: post
title: ASP.NET Core Grid Column Pinning | Syncfusion
description: Learn how to freeze and pin columns in ASP.NET Core Data Grid to keep important fields visible while scrolling and synchronize frozen content.
platform: grid-sdk
...
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/frozen-columns/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Frozen.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/frozen-columns/frozen.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/frozen-particular/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Frozen.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/frozen-particular/frozen.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/frozen-direction/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Frozen.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/frozen-direction/frozen.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/frozen-color/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Frozen.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/frozen-color/frozen.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/frozen-datepicker/tagHelper %}
{% endhighlight %}

{% highlight c# tabtitle="Frozen.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/frozen-datepicker/frozen.cs %}
{% endhighlight %}
{% endtabs %}
