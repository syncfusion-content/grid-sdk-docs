---
layout: post
title: ASP.NET Core Grid Column Headers | Syncfusion
description: Learn how to customize column headers in ASP.NET Core Data Grid with header text, templates, tooltips, and multi-line layouts.
platform: grid-sdk
control: Headers
...
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Headertext.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext/headertext.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertemplate/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Headertemplate.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertemplate/headertemplate.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-stacked/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Stackedheader.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-stacked/stackedHeader.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-textalign/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Headertext.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-textalign/headertext.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-autowrap/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Headertext.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-autowrap/headertext.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-change-height/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Headertext.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-change-height/headertext.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-change/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Columntext.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-change/columntext.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-change-all/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Columntext.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-change-all/columntext.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-orientation/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Headertext.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-orientation/headertext.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-tooltip/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Headertext.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-tooltip/headertext.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-using-css/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Headertext.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-using-css/headertext.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-using-property/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Headertext.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-using-property/headertext.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-using-method/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Headertext.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-using-method/headertext.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-using-event/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Headertext.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-using-event/headertext.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-refresh/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Headertext.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/columns/headertext-refresh/headertext.cs %}
{% endhighlight %}
{% endtabs %}
