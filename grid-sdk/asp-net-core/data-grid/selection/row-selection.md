---
layout: post
title: ASP.NET Core Grid Row Selection | Syncfusion
description: Learn how to select single or multiple rows in ASP.NET Core Data Grid with selection modes, keyboard interactions, selection APIs, and row selection events.
platform: grid-sdk
...
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-single-selection/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="row-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-single-selection/row-selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-multiple-selection/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="row-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-multiple-selection/row-selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-initial-rendering/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="row-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-initial-rendering/row-selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-index/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="row-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-index/row-selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-single-click/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="row-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-single-click/row-selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-single-method/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="row-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-single-method/row-selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-multiple-method/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="row-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-multiple-method/row-selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-range-selection/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="row-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-range-selection/row-selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-certain-condition/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="row-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-certain-condition/row-selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-get-selected/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="row-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-get-selected/row-selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-selected-various-pages/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="row-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-selected-various-pages/row-selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-selected-records/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="row-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-selected-records/row-selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-clear-selection/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="row-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-clear-selection/row-selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-selection-events/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="row-selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/row-selection-events/row-selection.cs %}
{% endhighlight %}
{% endtabs %}
