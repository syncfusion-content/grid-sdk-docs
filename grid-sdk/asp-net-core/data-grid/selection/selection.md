---
layout: post
title: ASP.NET Core Grid Selection | Syncfusion
description: Learn how to use selection in ASP.NET Core Data Grid with row, cell, and column selection modes, selection APIs, keyboard interactions, and selection events.
platform: grid-sdk
control: Selection
...
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/selection/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/selection/selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/selection-mode/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="selection-mode.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/selection-mode/selection-mode.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/toggleselection/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="toggleselection.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/toggleselection/toggleselection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/selection-clear/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/selection-clear/selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/selection-persist/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="selection.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/selection/selection-persist/selection.cs %}
{% endhighlight %}
{% endtabs %}
