---
layout: post
title: ASP.NET Core Grid Searching | Syncfusion
description: Learn how to search data in ASP.NET Core Data Grid with built-in search functionality, search configuration options, case sensitivity, and result highlighting.
platform: grid-sdk
control: Searching
...
{% include code-snippet/grid-sdk/asp-net-core/grid/search/search/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="search.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/search/search.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/initial-search/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="initial-search.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/initial-search/initial-search.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/search-operators/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="search-operators.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/search-operators/search-operators.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/external-btn/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="external-btn.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/external-btn/external-btn.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/search-a-column/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="search-a-column.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/search-a-column/search-a-column.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/search-each-key/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="search-each-key.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/search-each-key/search-each-key.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/column-formatting/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="column-formatting.cs " %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/column-formatting/column-formatting.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/search-multiple-keywords/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="search-multiple-keywords.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/search-multiple-keywords/search-multiple-keywords.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/ignore-accent/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="ignore-accent.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/ignore-accent/ignore-accent.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/high-light-text/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="highlight-text.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/high-light-text/high-light-text.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/clear-search/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="clear-search.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/clear-search/clear-search.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/retrieve-records/tagHelper %}
{% endhighlight %}

{% highlight c# tabtitle="retrieve-records.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/search/retrieve-records/retrieve-records.cs %}
{% endhighlight %}
{% endtabs %}
