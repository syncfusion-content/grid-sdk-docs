---
layout: post
title: ASP.NET Core Grid Group and Caption Aggregates | Syncfusion
description: Learn how to compute and display group and caption aggregates in ASP.NET Core Data Grid, including group summaries, captions, and aggregate formatting.
platform: grid-sdk
...
{% include code-snippet/grid-sdk/asp-net-core/grid/aggregate/group-footer-aggregates/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="group-footer.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/aggregate/group-footer-aggregates/group-footer.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/aggregate/group-caption-aggregates/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="group-caption.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/aggregate/group-caption-aggregates/group-caption.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/aggregate/group-disable-page/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="group-caption.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/aggregate/group-disable-page/group-caption.cs %}
{% endhighlight %}
{% endtabs %}
