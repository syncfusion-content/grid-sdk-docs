---
layout: post
title: ASP.NET Core Grid Aggregates | Syncfusion
description: Learn how to use aggregates in ASP.NET Core Data Grid to display column summaries, footer and group aggregates, and create custom aggregate calculations.
platform: grid-sdk
control: Aggregates
