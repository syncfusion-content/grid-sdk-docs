...
{% include code-snippet/grid-sdk/asp-net-core/grid/paging/change-page-size/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="page.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/paging/change-page-size/page.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/paging/change-page-count/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="page.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/paging/change-page-count/page.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/paging/change-current-page/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="page.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/paging/change-current-page/page.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/paging/add-query-string/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="page.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/paging/add-query-string/page.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/paging/pager-template/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="page-template.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/paging/pager-template/page-template.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/paging/pager-dropdown/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="page.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/paging/pager-dropdown/page.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/paging/customize-page-dropdown/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="page.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/paging/customize-page-dropdown/page.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/paging/navigate-particular-page/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="page.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/paging/navigate-particular-page/page.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/paging/dynamically-calculate/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="page.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/paging/dynamically-calculate/page.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/paging/render-pager/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="page.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/paging/render-pager/page.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/paging/pager-events/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="page.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/paging/pager-events/page.cs %}
{% endhighlight %}
{% endtabs %}
