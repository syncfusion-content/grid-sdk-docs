---
layout: post
title: ASP.NET Core Grid Server-Side PDF Export | Syncfusion
description: Learn how to export ASP.NET Core Data Grid data using server-side PDF generation, API endpoints, and efficient export processing for large datasets.
platform: grid-sdk
...
{% include code-snippet/grid-sdk/asp-net-core/grid/pdf-export/server-export/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Server-exportCore.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/pdf-export/server-export/server-exportCore.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/pdf-export/rotate-header/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Rotate-Header.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/pdf-export/rotate-header/rotate-header.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/pdf-export/additonal-parameter/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Rotate-Header.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/pdf-export/additonal-parameter/additional-parameter.cs %}
{% endhighlight %}
{% endtabs %}
