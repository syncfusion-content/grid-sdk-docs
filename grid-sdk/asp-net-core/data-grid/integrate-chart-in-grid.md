---
layout: post
title: ASP.NET Core Grid Integrate Chart in Grid | Syncfusion
description: Learn how to integrate charts in ASP.NET Core Data Grid by embedding charts in cells or detail views to visualize and analyze data effectively.
platform: grid-sdk
...
{% include code-snippet/grid-sdk/asp-net-core/grid/chart-intergartion/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="chart.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/chart-intergartion/chartcore.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/chart-intergartion1/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="chart.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/chart-intergartion1/chartcore.cs %}
{% endhighlight %}
{% endtabs %}
