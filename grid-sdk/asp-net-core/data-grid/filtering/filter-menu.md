...
{% include code-snippet/grid-sdk/asp-net-core/grid/filtering/filtermenu/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="filtermenu.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/filtering/filtermenu/filtermenu.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/filtering/filter-menu-component/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="filtermenu.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/filtering/filter-menu-component/filtermenu.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/filtering/filter-menu-format/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="filtermenu.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/filtering/filter-menu-format/filtermenu.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/filtering/filter-menu-operators/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="filtermenu.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/filtering/filter-menu-operators/filtermenu.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/filtering/filter-menu-multiple-keywords/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="filtermenu.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/filtering/filter-menu-multiple-keywords/filtermenu.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/filtering/filter-menu-menu-dialog/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="filtermenu.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/filtering/filter-menu-menu-dialog/filtermenu.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/filtering/filter-menu-hide-method/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="filtermenu.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/filtering/filter-menu-hide-method/filtermenu.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/filtering/filter-menu-events/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="filtermenu.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/filtering/filter-menu-events/filtermenu.cs %}
{% endhighlight %}
{% endtabs %}
