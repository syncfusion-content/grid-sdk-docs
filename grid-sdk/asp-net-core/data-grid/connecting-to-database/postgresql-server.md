---
layout: post
title: ASP.NET Core Grid PostgreSQL Server Data Binding | Syncfusion
description: Learn how to connect ASP.NET Core Data Grid to PostgreSQL Server, bind data through API services, and perform efficient CRUD operations.
platform: grid-sdk
control: grid
