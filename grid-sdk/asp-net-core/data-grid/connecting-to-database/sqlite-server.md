---
layout: post
title: Bind SQLite Server Data in Syncfusion ASP.NET Core Grid
description: Learn how to consume data from SQLite Server, bind it to Syncfusion ASP.NET Core Grid, and perform CRUD operations.
control: grid
platform: grid-sdk
