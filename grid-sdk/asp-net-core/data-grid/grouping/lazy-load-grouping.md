---
layout: post
title: ASP.NET Core Grid Lazy Load Grouping | Syncfusion
description: Learn how to use Lazy Load Grouping in ASP.NET Core Data Grid to load grouped records on demand, improve performance, and efficiently handle large datasets.
platform: grid-sdk
...
{% include code-snippet/grid-sdk/asp-net-core/grid/grouping/lazy-load-grouping/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="lazy-load.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/grouping/lazy-load-grouping/lazy-load.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/grouping/lazy-load-grouping-scroll/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="lazy-load-grouping-scroll.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/grouping/lazy-load-grouping-scroll/lazy-load-grouping-scroll.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/grouping/group-virtual/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="virtual-scroll.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/grid/grouping/group-virtual/virtual-scroll.cs %}
{% endhighlight %}
{% endtabs %}
